<x-guest-layout>
    ...
    <form method="POST" action="/barang/{{$barangs->id}}" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <div class="mt-4">
            ...
            <select id="jenis" name="jenis" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                ...
                <option value="{{$item->id}}" @if($item->id == $barangs->jenis_id)
                    selected
                    @endif
                    >{{$item->nama}}</option>
                @endforeach
        ...
        <div class="mt-4">
            ...
            <select id="kondisi" name="kondisi" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                ...
                <option value="{{$item->id}}" @if($item->id == $barangs->kondisi_id)
                    selected
                    @endif
                    >{{$item->nama}}</option>
                @endforeach
        ...
        <div class="mt-4">
            ...
            <textarea id="keterangan" name="keterangan" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{$barangs->keterangan}}</textarea>
        ...
        <div class="mt-4">
            ...
            <textarea id="kecacatan" name="kecacatan" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{$barangs->kecacatan}}</textarea>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="jumlah" class="block mt-1 w-full" type="text" name="jumlah" value="{{$barangs->jumlah}}" required autofocus autocomplete="jumlah" />
